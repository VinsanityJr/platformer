...
class Main_Menu(screen.Screen):
    def __init__(self):
        ...
        super().add_drawable(button.Button(colors.BLACK, (10, 200), (30, 30), self.to_village_square))

    def to_village_square(self):
        settings.screen = screens.village_square_screen
